...
**Routes** are independent narratives over the same cards. Two routes may visit the same pair of cards in opposite orders, and a route may revisit a card. This means the combined step-order across all of a space's routes can contain a **cycle**, and that is legal — a space is not required to have a consistent global ordering of its cards.
