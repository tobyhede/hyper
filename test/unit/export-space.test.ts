    ...
    document: {
      ...
      layouts: [
        ...
        },
        {
          ...
          kind: 'positioned',
          positions: {
            [CARD_E]: { x: 0, y: 200, state: 'closed' },
            [CARD_F]: { x: 260, y: 200, state: 'closed' },
          },
        ...
        layouts: [
          {
            ...
            title: 'Spine',
            positions: {
              [CARD_A]: { y: 0, x: 0, state: 'closed' },
              [CARD_B]: { y: 0, x: 260, state: 'closed' },
            },
            id: SPINE_LAYOUT_ID,
          },
          {
            title: 'Echo',
            positions: {
              [CARD_F]: { y: 200, x: 260, state: 'closed' },
              [CARD_E]: { y: 200, x: 0, state: 'closed' },
            },
