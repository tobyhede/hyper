 ...
 * one-thing snapshot, which reads as three unrelated fixtures that coincidentally
 * agree — and would drift the moment one of them needed a second thing.
 */
export const SPACE_ID = uuidSchema.parse('00000000-0000-4000-8000-000000000001');
export const THING_ID = uuidSchema.parse('00000000-0000-4000-8000-000000000002');

export const oneThingSnapshot: SpaceSnapshot = {
  id: SPACE_ID,
