 ...
 * so no test that asserts on layout quietly changes meaning. Resource geometry is
 ...
 * `space-resource-embedded-map.test.tsx`'s embedded-persistence case red, and
 ...
 * Resource rail's controls, which are toolbar items under ADR 0070, throw on
