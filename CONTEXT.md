...
_Avoid_: expand as a *second verb* beside Opening (a Card is Opened, and Expanded is the state that leaves it in), preview, popup, modal, dialog, drill-down, view mode and edit mode (Opening has one surface, and it is the Card).
