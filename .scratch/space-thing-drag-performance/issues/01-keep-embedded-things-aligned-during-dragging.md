...
- [x] Moving descendants of a dragged ancestor do not interpolate toward stale positions. Cover multiple embedding levels and multi-selection, accounting for React Flow subflow children being DOM siblings rather than descendants of the parent wrapper.
