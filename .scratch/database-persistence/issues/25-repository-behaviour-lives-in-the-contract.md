...
- [ ] Moved into the contract: truncation of broken stored state (ADR 0094; PostgreSQL 261–400, SQLite 480–566), survival across reopen (SQLite 568, PostgreSQL 583), and the intake cases only PostgreSQL runs (PostgreSQL 1272–1542).
