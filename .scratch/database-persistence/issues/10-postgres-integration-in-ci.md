...
- [ ] The gate runs both the typed Prisma/PostgreSQL smoke tests and the complete `PostgresSpaceRepository` integration suite, including transactional commits, optimistic conflicts, rollback, and insert-only import behavior.
