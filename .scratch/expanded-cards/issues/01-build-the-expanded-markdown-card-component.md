...
- [ ] ADR 0064 owns the interaction this ticket builds — a closed Card offers Edit and Open, Edit on a closed Card opens it and then begins the edit, Save and Cancel replace Edit while one runs, and Close stays visible but disabled. Read it before the checklist below.
