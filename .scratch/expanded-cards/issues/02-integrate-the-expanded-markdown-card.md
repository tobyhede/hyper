...
- [x] An open Card offers Edit then Close in its rail; while Markdown editing runs, Save and Cancel replace Edit and Close remains present but disabled. Rendered Markdown contains no second edit control or pencil affordance.
- [x] Rendered Markdown remains ordinary Card drag surface until editing begins from the rail. A live CodeMirror caret owns text selection and keyboard input without disabling unrelated Card gestures after the edit ends.
