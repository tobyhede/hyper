...
- **Where the toolbar sits.** On an untitled Edge it is centred on the line's midpoint, since nothing else is drawn there; a refusal hangs below it without moving it. On a titled Edge — or while a Title is being written, whose field is centred on the midpoint — it floats above the Title.
