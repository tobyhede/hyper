...
- [ ] Handle the existing Popover Anchor usage as an inert compatibility boundary because Base UI has no equivalent, and flag that gap rather than claiming it was migrated.
