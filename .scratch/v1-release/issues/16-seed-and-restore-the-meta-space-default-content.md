...
First slice (2026-09-14): only the Open Markdown Resource. Default Content on
first init; `newSpace` unchanged. Meta Space name `Space`. Resource title
...
from `newId`. Closed Markdown, Alias, Space Resource, example Space, frozen
