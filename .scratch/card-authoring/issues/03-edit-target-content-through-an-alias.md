...
Implemented in `c6572bc`. Opening an Alias preserves it as the visible context,
...
The decision itself is ADR 0039, which refines 0037. ADR 0037's own record — that
