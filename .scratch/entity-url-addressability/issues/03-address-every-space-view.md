...
- [x] A malformed identity returns 400, an unresolved Space View returns an actual 404, and a namespace collision is treated as a broken invariant rather than precedence.
- [x] Server and client navigation use one destination contract and `pnpm verify` plus `pnpm e2e` pass.
