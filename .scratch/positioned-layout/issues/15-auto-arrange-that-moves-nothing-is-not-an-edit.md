...
Obsolete with the generic Auto-arrange concept. The prototype button is removed
rather than given special no-op semantics. Algorithmic placement is exposed as
a concrete View selected from the toolbar; selection is navigation and is not
an edit. Editing that View converts it into a new Positioned Layout under the
uniform ADR 0025 rule. ADR 0031 records the decision and issue 16 carries the
replacement.
