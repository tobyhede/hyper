...
interface InlineTitleEditorBase {
   ...
   * the Sidebar and header do not — which is also what keeps the answer
 ...
 * - Tests: `InlineTitleEditor.test.tsx`, `CanvasCard.test.tsx`, `SpaceSidebar.test.tsx`,
 *   application and Ladle Playwright.
 */
