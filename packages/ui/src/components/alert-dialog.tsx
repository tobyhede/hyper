      ...
      */}
      ...
      <AlertDialogPortal container={ownerDocumentBody}>
        ...
        <AlertDialogPrimitive.Popup
          ...
          data-size={size}
          className={cn(
            // `--alert-dialog-spacing` is the popup's own padding, named so the
            ...
            // arrangement `Resource` uses for the same band (`resource.tsx`).
...
function AlertDialogFooter({ className, ...props }: React.ComponentProps<'div'>) {
  return (
    <div
      ...
      // fill read as a grey resource floating inside the dialog with a white strip
