...
| Piece | Purpose |
| ----- | ------- |
| `resources` | Markdown content + frontmatter |
| `graphs` | Graphs of unique `{ from, to }` edges; cycles are allowed |

Resources provide the content, and Graphs are the only connection structure — each
Graph's Edges reference Resources directly.
