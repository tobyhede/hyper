  ...
  const result = loadSpace(
    {
      ...
      layouts: [
        ...
        },
        {
          ...
          title: 'Second graph',
          positions: {
            [CARD_B]: { x: 0, y: 200, state: 'closed' },
            [CARD_C]: { x: 320, y: 200, state: 'closed' },
          },
      ...
      layouts: [
        {
          ...
          positions: Object.fromEntries(
            cards.map((card, index) => [card.id, { x: index * 320, y: 0, state: 'closed' }]),
          ),
          graphs,
        },
      ],
      ...
      layouts: [
        {
          ...
          title: 'First graph',
          positions: {
            [cardA]: { x: 0, y: 0, state: 'closed' },
            [cardB]: { x: 320, y: 0, state: 'closed' },
            [cardC]: { x: 640, y: 0, state: 'closed' },
          },
          graphs: [
            {
              id: GRAPH_ONE,
