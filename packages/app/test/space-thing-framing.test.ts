...
import {
  ...
  viewportFromFraming,
  zoomFraming,
} from '../src/space-thing-framing';

const bounds = { left: 16, top: 16, right: 416, bottom: 316 };
const origin = { x: 80, y: 60 };

describe('Space Thing portal framing', () => {
  it('fits from the Diagram origin when nothing has been framed yet', () => {
  ...
  it('builds an entered viewport from the browser canvas size, not the source Thing', () => {
