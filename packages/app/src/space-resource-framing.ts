import type { MapPosition, ResourceDocument } from '@project/core';
...
/**
 * How an embedding places authored coordinates inside the Space Resource's window.
 *
 * Absent framing fits the selected Map from its origin into the inset, which
 ...
 * stored zoom, independent of the containing Resource's size on Enter.
 */
...
/** Inverse of the embed camera: a pointer proposal back into Map coordinates. */
