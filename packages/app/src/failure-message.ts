/**
 * What a thrown resource says, for the one sentence a surface shows about it.
 *
 ...
 * `ResourceCreationBreak` name their own. It reads a message where there is one and
