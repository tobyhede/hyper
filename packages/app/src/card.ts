...
import { CLOSED_CARD_SIZE } from '@project/core';

export const CARD_ASPECT_RATIO = 16 / 9;

export const CARD_WIDTH = CLOSED_CARD_SIZE.width;
export const CARD_HEIGHT = CLOSED_CARD_SIZE.height;

/** The size a layout arranges cards at. */
export const CARD_SIZE = { width: CARD_WIDTH, height: CARD_HEIGHT } as const;
export const DEFAULT_OPEN_CARD_SIZE = { width: 560, height: 420 } as const;
