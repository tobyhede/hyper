 ...
 * than a look: the Space reader Navigation resolves every selection against,
 * the rule that the instance is *state* rather than a memo, and the one call that puts a story in the state it is about. Delete this
