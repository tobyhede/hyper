...
/** Four Edges out of one Resource, the longest of them well past what the row can hold. */
 ...
 *
 * A sink cannot be the Resource a traversal begins at — every Resource a Graph can start
