 ...
 * pixels with the Resources and the HUD. A component story at 1:1 shows none of that
...
/** As an author meets it: the whole Map in view, controls at that scale. */
 ...
 * it, and covers the two Resources the Edge runs between. Left as a detail to look
...
export const DeletionRefusalOnCanvas: Story = () => (
  <SelectedEdgeCanvasFixture
    refusal={{ kind: 'deletion', refusal: { code: 'map-required', operation: 'deleted-edge' } }}
  />
);
