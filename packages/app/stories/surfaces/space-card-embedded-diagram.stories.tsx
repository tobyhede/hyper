...
/**
 * The target Space, whose Diagram the Space Card selects.
 *
 * Two Cards and the one Graph joining them, at the rects its own Diagram
 ...
 * `SPACE_CARD_EMBED_INSET` reserved, so what is on screen is the whole Diagram
 ...
 * distinction the whole surface rests on: the Diagram drawn is the **Card's**
